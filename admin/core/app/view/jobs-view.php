                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form class="form-horizontal" method="post" id="addcategory"
                                  action="index.php?action=jobs&opt=add" role="form">
                                <div class="form-group">
                                    <label for="name" class="col-lg-2 control-label">Titulo*</label>
                                    <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for="requirements" class="col-lg-2 control-label">Requerimientos*</label>
                                    <div class="col-md-6">
                                        <textarea name="requirements" required class="form-control" id="requirements"
                                                  placeholder="Requerimientos"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="limit_at" class="col-lg-2 control-label">Fecha limite*</label>
                                    <div class="col-md-6">
                                        <input type="date" name="limit_at" required class="form-control" id="limit_at"
                                ...
                                <div class="form-group">
                                    <label for="place_id" class="col-lg-2 control-label">Lugar </label>
                                    <div class="col-md-6">
                            ...
                            foreach ($users as $user) {
                                ...
                                <tr>
                                    ...
                                    <td style="width:130px;">
                                        ...
                                        <a href="index.php?action=jobs&opt=del&id=<?php echo $user->id; ?>"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form class="form-horizontal" method="post" id="addproduct"
                                                  action="index.php?action=jobs&opt=update" role="form">


                                                <div class="form-group">
                                                    <label for="inputEmail1"
                                                           class="col-lg-2 control-label">Titulo*</label>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <textarea name="description" required class="form-control"
                                                                  id="description"
                                                                  placeholder="Descripcion"><?php echo $user->description; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="inputEmail1" class="col-lg-2 control-label">Requerimientos*</label>
                                                    <div class="col-md-6">
                                                        <textarea name="requirements" required class="form-control"
                                                                  id="requirements"
                                                                  placeholder="Requerimientos"><?php echo $user->requirements; ?></textarea>
                                                    </div>
                                                </div>

                                                <div class="form-group">
                                                    <label for="inputEmail1" class="col-lg-2 control-label">Fecha
                                                        limite*</label>
                                                    <div class="col-md-6">
                                                        <input type="date" name="limit_at" required class="form-control"
                                                               value="<?php echo $user->limit_at; ?>" id="limit_at"
                                                               placeholder="Fecha limite">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="inputEmail1"
                                                           class="col-lg-2 control-label">Categoria </label>
                                                    <div class="col-md-6">
                                                        <select name="category_id" class="form-control" required>
                                                            <option value="">-- SELECCIONAR --</option>
                                                            <?php foreach (CategoryData::getAll() as $g): ?>
                                                                <option value="<?php echo $g->id; ?>" <?php if ($user->category_id == $g->id) {
                                                                    echo "selected";
                                                ...
                                                <div class="form-group">
                                                    <label for="inputEmail1"
                                                           class="col-lg-2 control-label">Lugar </label>
                                                    <div class="col-md-6">
                                                        <select name="place_id" class="form-control" required>
                                                            <option value="">-- SELECCIONAR --</option>
                                                            <?php foreach (PlaceData::getAll() as $g): ?>
                                                                <option value="<?php echo $g->id; ?>" <?php if ($user->place_id == $g->id) {
                                                                    echo "selected";
                                                                } ?>><?php echo $g->name; ?></option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    <label for="inputEmail1" class="col-lg-2 control-label">Esta
                                                        activo</label>
                                                    <div class="col-md-6">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox"
                                                                       name="status" <?php if ($user->status == 1) {
                                                                    echo "checked";
                                                                } ?>>
                                                            </label>
                                                        </div>
